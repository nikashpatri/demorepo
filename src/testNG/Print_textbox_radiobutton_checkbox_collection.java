...
public class Print_textbox_radiobutton_checkbox_collection {
	WebDriver driver;
  @Test
  public void test1() {
	  ...
	  for (int i = 0; i < s.size(); i++) {
		  ...
		  {
			  System.out.println("text_box:"+s.get(i).getAttribute("name"));
		  }
		  else if(s.get(i).getAttribute("class").equalsIgnoreCase("log"))
		  {
			  System.out.println("button:"+s.get(i).getAttribute("value"));
		  }
